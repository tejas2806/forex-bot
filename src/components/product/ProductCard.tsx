...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="relative">
      ...
      {loginAlert && (
        <div
          className={`pointer-events-none absolute inset-x-3 bottom-3 z-20 rounded-lg bg-amber-500/12 px-2.5 py-2 text-xs text-amber-200 shadow-[0_8px_24px_rgba(0,0,0,0.35)] backdrop-blur-sm transition-all duration-500 ${
